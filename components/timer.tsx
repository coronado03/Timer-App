        ...
        <>
          <div className="group flex flex-col items-center mr-10 place-self-end md:place-self-center md:mr-0 md:ml-12 md:row-span-2 md:row-start-1 md:row-end-3 md:col-start-1 md:mb-20">
            ...
            <div className="flex mb-[-19px]">
              <h1 className="text-9xl md:text-[9rem] lg:text-[11rem] xl:text-[13rem] text-white group-hover:text-[#CC1C1C] transition ease-in-out">{days}</h1>
            ...
            <div className="flex mb-[-25px]">
              <h1 className="text-8xl md:text-[7rem] lg:text-[8rem] xl:text-[10rem] text-white group-hover:text-[#CC1C1C] transition ease-in-out">{hours}</h1>
            ...
            <div className="flex gap-4 mr-14 text-4xl md:text-[2.8rem] lg:text-[3.4rem] xl:text-[3.8rem] md:mt-5 lg:mt-7 text-white">
              <h1 className="group-hover:text-[#CC1C1C] transition ease-in-out">{minutes}</h1>
              <h1 className="group-hover:text-[#CC1C1C] transition ease-in-out">{seconds}</h1>
            </div>
